...
namespace alumni.Migrations
{
    ...
    [Migration("20220210120550_change_school_identitydb_short_name_to_acronym")]
    partial class change_school_identitydb_short_name_to_acronym
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolIdentity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("alumni.Domain.School", b =>
                {
                    b.HasOne("SchoolIdentity", "SchoolIdentity")
                        .WithMany()
                        .HasForeignKey("SchoolIdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
