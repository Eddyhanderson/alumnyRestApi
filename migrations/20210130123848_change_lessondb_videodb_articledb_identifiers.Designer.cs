...
namespace alumni.Migrations
{
    ...
    [Migration("20210130123848_change_lessondb_videodb_articledb_identifiers")]
    partial class change_lessondb_videodb_articledb_identifiers
    {
            ...
            modelBuilder.Entity("alumni.Domain.Lesson", b =>
                {
                    ...
                    b.Property<string>("DiscpilineTopicId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("alumni.Domain.Lesson", b =>
                {
                    b.HasOne("alumni.Domain.DisciplineTopic", "DisciplineTopic")
                        .WithMany()
                        .HasForeignKey("DiscpilineTopicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
